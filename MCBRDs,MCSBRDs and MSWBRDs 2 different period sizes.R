...
(H<-CGSBRMD_2diffsize(p=c(7,5),v=27,i=3,D=1,sp2=1))
(H<-CGSBRMD_2diffsize(p=c(4,3),v=13,i=2,D=1,sp2=1))
(H<-CGSBRMD_2diffsize(p=c(7,3),v=32,i=4,D=1,sp2=1))
(design_CGSBRMD(H))
...
(H<-CGSBRMD_2diffsize(p=c(8,4),v=33,i=3,D=1,sp2=2))
